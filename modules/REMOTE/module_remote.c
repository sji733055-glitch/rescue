...
void module_remote_init()
{
    ...
    UINT status =tx_thread_create(&remote_decode_task,"remote_task",remote_task_entry,0,remote_decode_stack,REMOTE_TASK_STACK_SIZE,REMOTE_TASK_PRIORITY,REMOTE_TASK_PRIORITY,TX_NO_TIME_SLICE,TX_AUTO_START);
